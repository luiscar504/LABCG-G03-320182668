...
int main()
{
	...
	CrearCono(5, 2.0f);//índice 3 en MeshList
	...
	*/
	...
	glm::vec3 color = glm::vec3(0.0f,1.0f,0.0f); //inicializar Color para enviar a variable Uniform;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/*
		// K, L, X y C para mover cada una de las llantas
			//CABINA
			model = glm::mat4(1.0);
		...
		//Ejercicio dibujar la canasta y terminar el brazo
		//Tercer brazo
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0f, 1.0f, 1.0f));
		...
		*/
		...
		//ANIMAL ROBOT
		// Z mover cola 
		// F mover primera articulacion de la pierna delantera derecha
		// G mover segunda articulacion de la pierna delantera derecha
		// H mover primera articulacion de la pierna delantera izquierda
		// J mover segunda articulacion de la pierna delantera izquierda
		// K mover primera articulacion de la pierna trasera derecha
		// L mover segunda articulacion de la pierna trasera derecha
		// X mover primera articulacion de la pierna trasera izquierda
		// C mover segunda articulacion de la pierna trasera izquierda

		//Cuerpo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux2 = modelaux = model;
		model = glm::scale(model, glm::vec3(3.6f, 3.0f, 2.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.75f, 0.75f, 0.75f);
		...
		//articulacion 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.3f, 0.5f, 1.4f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, -1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.75f, 0.75f, 0.75f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.8f, 2.6f, 1.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::translate(model, glm::vec3(0.7f, -1.35f, 0.0f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.1f, 2.4f, 1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::translate(model, glm::vec3(0.5f, -1.08f, 0.0f));
		modelaux = model;
		...
		//garras
		model = glm::translate(model, glm::vec3(0.5f, -0.25f, -0.4f));
		modelaux = model;
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.3f, -1.55f, 0.0f));
		model = glm::rotate(model, glm::radians(225.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(2.1f, 2.1f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.75f, 0.75f, 0.75f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::scale(model, glm::vec3(0.35f, 0.9f, 0.9f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.02f, 1.1f, 1.0f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.35f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::rotate(model, glm::radians(350.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.7f, 1.3f, 1.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::rotate(model, glm::radians(350.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.7f, 0.5f, 0.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//colmillos
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.9f, -0.9f, 0.43f));
		model = glm::rotate(model, glm::radians(350.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//ojos
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.82f, 0.55f, 0.78f));
		...
		//segunda sección del torso
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.7f, 0.0f, 0.0f));
		modelaux2 = modelaux = model;
		model = glm::scale(model, glm::vec3(2.5f, 2.6f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//articulacion 5
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.6f, 0.5f, 1.2f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, -1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.75f, 0.75f, 0.75f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.3f, 2.5f, 1.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.1f, 2.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.25f, 0.25f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::translate(model, glm::vec3(-2.75f, 0.0f, 0.4f));
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(-2.65f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(30.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 0.2f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.75f, 0.75f, 0.75f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
