...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_F)
	{
		theWindow->articulacion1 += 10.0*dir;
	...
	if (key == GLFW_KEY_G)
	{
		theWindow->articulacion2 += 10.0 * dir;
	...
	if (key == GLFW_KEY_H)
	{
		theWindow->articulacion3 += 10.0 * dir;
	...
	if (key == GLFW_KEY_J)
	{
		theWindow->articulacion4 += 10.0 * dir;
	...
	if (key == GLFW_KEY_K)
	{
		theWindow->articulacion5 += 2.0;
	}
	if (key == GLFW_KEY_L)
	{
		theWindow->articulacion6 += 2.0;
	}
	if (key == GLFW_KEY_X)
	{
		if(theWindow->articulacion7 <= 90)
			theWindow->articulacion7 += 2.0;
	}
	if (key == GLFW_KEY_C)
	{
